<div class="card d-none" id="createCard">
    ...
    <div class="card-body">
        <form method="post" id="createForm">
            ...
            <div class="form-group">
                <label for="jabatanCreate">jabatan</label>
                <input type="text" id="jabatanCreate" name="jabatan" class="form-control error-form jabatan_error_form" placeholder="ISI jabatan">
                <span class="text-danger error-text" id="jabatan_error"></span>
            </div>
