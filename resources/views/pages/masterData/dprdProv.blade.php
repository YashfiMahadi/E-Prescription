        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4><strong>DPRD Prov</strong></h4>
                        <span>Master Data DPRD Prov</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ URL::to('/admin/dprd-prov') }}">DPRD Prov</a> </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card" id="tableCard">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <a href="{{ URL::to('/admin/dprd-prov/export') }}" class="btn btn-success">
                ...
                @include('components.actions.masterData.dprdProv.create')
                @include('components.actions.masterData.dprdProv.edit')
                @include('components.modals.masterData.dprdProv.table')
                @include('components.modals.masterData.dprdProv.import')
            </div>
        </div>
    </div>
@endsection
