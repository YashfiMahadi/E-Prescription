        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4><strong>DPR RI</strong></h4>
                        <span>Master Data DPR RI</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ URL::to('/admin/dpr-ri') }}">DPR RI</a> </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card" id="tableCard">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <a href="{{ URL::to('/admin/dpr-ri/export') }}" class="btn btn-success">
                ...
                @include('components.actions.masterData.dprri.create')
                @include('components.actions.masterData.dprri.edit')
                @include('components.modals.masterData.dprri.table')
                @include('components.modals.masterData.dprri.import')
            </div>
        </div>
    </div>
@endsection
